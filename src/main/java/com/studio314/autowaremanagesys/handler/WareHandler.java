...
//    public Mono<Result> create(ServerRequest request) {
//        return ok().contentType(MediaType.APPLICATION_JSON)
//                .body(wareService.create(Integer.parseInt(request.pathVariable("uID")), request.pathVariable("wareName")));
//    }
    ...
    public Mono<ServerResponse> create(ServerRequest request) {
        return request.bodyToMono(HashMap.class)
                .flatMap(body -> {
                    ...
                    Result result = wareService.create(Integer.parseInt(request.pathVariable("uID")), wareName);
